...
def _rdf_datatype_from_sql(sql_type):
    try:
        ...
        datatype = _rdf_datatype_from_sql(sql_type.__mro__[1])
...
def _rdf_literal_from_sql_func(sql_type):
    try:
        ...
        RDF_From_SQLfunc_SQL_Type[sql_type] = \
            rdf_literal_from_sql
...
try:
    ...
    for rdf_datatype in (_rdf.XSD.dayTimeDuration, _rdf.XSD.duration,
        ...
        SQL_Literal_RDF_DataType[rdf_datatype]\
...
for rdf_datatype, sql_types in SQL_Literal_RDF_DataType.items():
